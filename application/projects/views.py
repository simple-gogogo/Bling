...
def edit_interface(interface_id):
    ...
    if request.method == 'POST':    
        json_str = request.get_data(as_text=True)
        json_data = json.loads(json_str)
        request_body = json_data['request_data']
        response_body = json_data['response_data']

        interface.request_body = json.dumps(request_body, ensure_ascii=False)
        interface.response_body = json.dumps(response_body, ensure_ascii=False)
